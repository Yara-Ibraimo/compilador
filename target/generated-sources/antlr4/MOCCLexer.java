...
public class MOCCLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__17", "T__18", "T__19", "T__20", "T__21", "T__22", "T__23", "REGISTERINT", 
			"REGISTERLONG", "MUL", "DIV", "ADD", "SUB", "LT", "LE", "GT", "GE", "EQ", 
			"NEQ", "ASSIGN", "ID", "INT", "DOUBLE", "CHAR", "STRING", "WS", "COMMENT", 
			"LINE_COMMENT"
		};
	}
	...
	public MOCCLexer(CharStream input) {
		super(input);
